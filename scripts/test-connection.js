    ...
    return __awaiter(this, void 0, void 0, function () {
        ...
        return __generator(this, function (_a) {
            switch (_a.label) {
                ...
                case 1:
                    _a.trys.push([1, 3, , 4]);
                    return [4 /*yield*/, (0, blob_1.list)({ token: token })];
                case 2:
                    blobs = (_a.sent()).blobs;
                    console.log('--- SUCCESS ---');
                    ...
                    if (blobs.length === 0) {
                        ...
                        console.log("Found ".concat(blobs.length, " file(s):"));
                        blobs.forEach(function (blob) { return console.log("- ".concat(blob.pathname, " (Size: ").concat(blob.size, " bytes)")); });
                    }
                    return [3 /*break*/, 4];
                case 3:
                    error_1 = _a.sent();
