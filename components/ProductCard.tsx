      ...
      <a className='group block bg-white dark:bg-gray-800 rounded-2xl shadow-lg overflow-hidden transform transition-all duration-300 hover:-translate-y-2 hover:shadow-2xl'>
        <div className='relative h-64 w-full overflow-hidden'>
          ...
          <button
            ...
            className='absolute top-4 right-4 bg-indigo-600 text-white p-3 rounded-full transform translate-x-16 group-hover:translate-x-0 transition-transform duration-300 hover:bg-indigo-700'
          >
