...
const Home = ({ products, categories }) => {
  ...
  const features = [
    { icon: <ShoppingCart size={28} />, title: 'Curated Collection', description: 'Handpicked styles for the modern trendsetter.' },
    { icon: <Zap size={28} />, title: 'Fast Shipping', description: 'Get your new look delivered to your door in no time.' },
    { icon: <ShieldCheck size={28} />, title: 'Secure Checkout', description: 'Shop with confidence using our secure payment gateway.' },
  ];
    ...
    <>
      ...
      <div className="bg-white dark:bg-gray-900 text-gray-800 dark:text-white">
        ...
        <section className="relative h-screen min-h-[700px] flex items-center">
          ...
          <div className="relative z-10 container mx-auto px-4 text-center text-white">
            ...
            <p className="max-w-2xl mx-auto text-lg md:text-xl mb-8 font-light animate-fade-in-up">
              Discover our collection of authentic and curated fashion items that speak to your unique personality.
            </p>
                ...
                <div className="grid grid-cols-1 md:grid-cols-3 gap-12 text-center">
                    {features.map(feature => (
                        <div key={feature.title} className="flex flex-col items-center">
                            ...
                            <p className="text-gray-600 dark:text-gray-400 max-w-xs">{feature.description}</p>
                        </div>
                    ))}
                </div>
            </div>
        ...
        <section className="py-24">
          <div className="container mx-auto px-4">
            <h2 className="text-4xl font-bold text-center mb-4">Trending Now</h2>
            <p className="text-center text-gray-600 dark:text-gray-400 mb-12">Check out our most popular products.</p>
          ...
          <div className="container mx-auto px-4">
            ...
            <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-8">
              {categories.map(category => (
                <Link href={`/products?category=${category.name.toLowerCase()}`} key={category.id} legacyBehavior>
        ...
        <section className="py-24 bg-indigo-700 text-white">
            <div className="container mx-auto px-4 text-center">
                ...
                <p className="max-w-2xl mx-auto mb-8">Subscribe to our newsletter for the latest styles, new arrivals, and exclusive offers.</p>
                <form className="max-w-lg mx-auto">
                    <div className="flex items-center bg-white/20 rounded-lg p-2">
                        <Mail className="h-6 w-6 mx-3 text-white/70" />
                        <input type="email" placeholder="Enter your email" className="w-full bg-transparent text-white placeholder-white/70 focus:outline-none py-2" />
                        <button type="submit" className="px-6 py-2.5 bg-white text-indigo-700 font-semibold rounded-md hover:bg-gray-200 transition-colors">
                            Subscribe
                        </button>
                    </div>
                </form>
