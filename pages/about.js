  ...
  return (
    <>
      <Head>
        ...
        <meta
          name='description'
          content='Pioneers in the liquid-glass industry, blending art and technology to create stunning, unique products.'
        />
      </Head>
        ...
        <section className='relative py-20 md:py-32 bg-gradient-to-r from-indigo-500 via-purple-500 to-pink-500 text-white text-center'>
          ...
          <div className='relative container mx-auto px-4'>
            ...
            <p className='text-lg md:text-xl max-w-3xl mx-auto'>
              We are pioneers in the liquid-glass industry, transforming a
              unique medium into breathtaking works of art through cutting-edge
              technology.
            </p>
          </div>
        </section>
        ...
        <section className='py-16 md:py-24'>
          <div className='container mx-auto px-4 text-center'>
            ...
            <p className='max-w-3xl mx-auto text-lg text-gray-600 dark:text-gray-400'>
              To push the boundaries of what&apos;s possible with liquid-glass,
              creating beautiful, durable, and one-of-a-kind pieces that inspire
              awe and bring a touch of magic into everyday life.
            </p>
          </div>
        </section>
            ...
            <div className='grid md:grid-cols-3 gap-12 text-center'>
              <div className='flex flex-col items-center'>
                ...
                <p className='text-gray-600 dark:text-gray-400'>
                  Every piece is a testament to our commitment to creativity and
                  aesthetic excellence, designed by artists who are masters of
                  their craft.
                </p>
              </div>
              <div className='flex flex-col items-center'>
                ...
                <p className='text-gray-600 dark:text-gray-400'>
                  We leverage state-of-the-art technology to ensure unparalleled
                  quality, durability, and a flawless finish in every creation.
                </p>
              </div>
              <div className='flex flex-col items-center'>
                ...
                <p className='text-gray-600 dark:text-gray-400'>
                  A passionate group of designers, engineers, and artisans
                  dedicated to bringing our shared vision of liquid-glass art to
                  life.
                </p>
              </div>
            </div>
        ...
        <section className='py-16 md:py-24'>
          <div className='container mx-auto px-4 text-center'>
            ...
            <p className='max-w-2xl mx-auto text-lg text-gray-600 dark:text-gray-400 mb-8'>
              Explore our collection of unique liquid-glass creations and find
